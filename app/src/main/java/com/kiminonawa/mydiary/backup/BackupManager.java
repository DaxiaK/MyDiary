...
public class BackupManager {
    ...
    public static class BackupTopicListBean {
        /**
         * contacts_topic_entries_list : [{"Contacts_entries_phonenumber":"090000000","Contacts_entries_name":"宮水 三葉","Contacts_entries_id":1}]
